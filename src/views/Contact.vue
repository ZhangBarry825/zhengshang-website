        ...
        <div class="map-box">
            ...
            <div class="center">
                <div class="left">
                    <div class="blue"></div>
                    <div class="map">
                        <baidu-map :center="center" :zoom="zoom" @ready="handler" style=" width: 582px;height: 512px;" @click="getClickInfo" :scroll-wheel-zoom='true'>
                        </baidu-map>
                    </div>
                </div>
                <div class="right">
                    ...
                    <el-form label-position="right" label-width="0" :model="formData" :rules="rules" ref="ruleForm">
                        ...
                        <el-form-item prop="description">
                            <el-input type="textarea" :rows="5" v-model="formData.description" placeholder="请输入简单需求（如网站建设、APP开发、软件开发、小程序开发等）"></el-input>
                        </el-form-item>
                    </el-form>
