    ...
    <div class="home">
        ...
        <div class="solve-methods">
            <div class="center">
                ...
                <div class="items">
                    <div :class="'item active-solve'+index" v-for="(item,index) in homeData.solution" v-if="index<3"
                         :key="index">
        ...
        <div class="news-center">
            <div class="center">
                ...
                <div class="items">
                    <div :class="'item active-news'+index" @click="$router.push({path: '/news-detail?id='+ item.id})"
                         v-for="(item,index) in homeData.news" v-if="index<4" :key="index">
                        <div class="left">
                            <div class="img" :style="'background-image: url('+item.img+')'"></div>
                        </div>
                        <div class="right">
